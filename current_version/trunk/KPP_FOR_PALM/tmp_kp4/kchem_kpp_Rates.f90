...
! End INLINED RCONST
  ...
  RCONST(1) = (phot(j_no2))
  RCONST(2) = (ARR2(1.4E+3_dp,1175.0_dp,temp))
  RCONST(3) = (ARR2(1.8E-12_dp,-1370.0_dp,temp))
  RCONST(4) = (ARR2(2.E-11_dp,-500.0_dp,temp))
  RCONST(5) = (ARR2(7.0E-12_dp,250.0_dp,temp))
  RCONST(6) = (phot(j_rcho))
  RCONST(7) = (ARR2(3.7E-12_dp,240.0_dp,temp))
  RCONST(8) = (ARR2(4.2E-12_dp,180.0_dp,temp))
  RCONST(9) = (ARR2(5.4E-12_dp,250.0_dp,temp))
  RCONST(10) = (ARR2(1.0E-12_dp,713.0_dp,temp))
  RCONST(11) = (ARR2(8.0E-20_dp,5500.0_dp,temp))
  RCONST(12) = (ARR2(9.4E+16_dp,-14000.0_dp,temp))
