...
! Former revisions:
! -----------------
! $Id: init_masks.f90 2425 2017-09-11 14:21:39Z basit $
!
...
!------------------------------------------------------------------------------!
 SUBROUTINE init_masks
    ...
    CHARACTER (LEN=10), DIMENSION(max_masks,100) ::  do_mask      !<
    CHARACTER (LEN=10), DIMENSION(max_masks,100) ::  do_mask_user !<
                ...
                IF ( unit == 'illegal' )  THEN
                   IF ( do_mask_user(mid,1) /= ' ' )  THEN
                      WRITE ( message_string, * ) 'illegal value for data_',&
                           ...
                           TRIM( do_mask(mid,i) ), '"'
                      CALL message( 'init_masks', 'PA0114', 1, 2, 0, 6, 0 )
                   ELSE
                      WRITE ( message_string, * ) 'illegal value for data_',&
