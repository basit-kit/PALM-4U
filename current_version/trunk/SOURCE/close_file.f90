...
! Former revisions:
! -----------------
! $Id: close_file.f90 2425 2017-09-11 14:21:39Z basit $
!
...
!------------------------------------------------------------------------------!
 SUBROUTINE close_file( file_id )
    ...
    USE control_parameters,                                                    &
        ONLY:  do2d_xz_n, do2d_xy_n, do2d_yz_n, do3d_avs_n, host, max_masks,   &
               mid, nz_do3d, openfile, run_description_header, z_max_do2d
