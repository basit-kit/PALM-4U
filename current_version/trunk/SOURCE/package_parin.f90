...
! Former revisions:
! -----------------
! $Id: package_parin.f90 2425 2017-09-11 14:21:39Z basit $
!
...
!------------------------------------------------------------------------------!
 SUBROUTINE package_parin
    ...
    USE control_parameters,                                                    &
        ONLY:  dt_data_output, dt_dopts, dt_dvrp, particle_maximum_age,        &
               threshold
    ...
    USE particle_attributes,                                                   &
        ONLY:  alloc_factor, bc_par_b, bc_par_lr, bc_par_ns, bc_par_t,         &
               ...
               init_aerosol_probabilistic, min_nr_particle,                    &
               monodisperse_aerosols, n1, n2, n3, number_of_particle_groups,   &
               particles_per_point, particle_advection,                        &
               particle_advection_start,                                       &
               pdx, pdy, pdz, psb, psl, psn, psr, pss, pst, radius,            &
               radius_classes, random_start_position,                          &
               read_particles_from_restartfile, rm1, rm2, rm3,                 &
               seed_follows_topography, step_dealloc, s1, s2, s3,              &
    ...
    NAMELIST /particles_par/      alloc_factor, bc_par_b, bc_par_lr,           &
                                  ...
                                  n1, n2, n3, number_of_particle_groups,       &
                                  particles_per_point,                         &
                                  particle_advection_start,                    &
                                  ...
                                  rm1, rm2, rm3,                               &
                                  seed_follows_topography, step_dealloc,       &
                                  s1, s2, s3, use_sgs_for_particles,           &
