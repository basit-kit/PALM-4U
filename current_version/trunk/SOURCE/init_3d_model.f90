...
!--    2D-rscalar arrays
       ALLOCATE ( rss(nysg:nyng,nxlg:nxrg),                                     &
                  rssws(nysg:nyng,nxlg:nxrg),                                   &
                  rsswst(nysg:nyng,nxlg:nxrg) )

!
!--    3D rscalar arrays
#if defined( __nopointer )
       ALLOCATE( rs(nzb:nzt+1,nysg:nyng,nxlg:nxrg),                             &
                 rs_p(nzb:nzt+1,nysg:nyng,nxlg:nxrg),                           &
                 trs_m(nzb:nzt+1,nysg:nyng,nxlg:nxrg) )
#else
       ALLOCATE( rs_1(nzb:nzt+1,nysg:nyng,nxlg:nxrg),                           &
                 rs_2(nzb:nzt+1,nysg:nyng,nxlg:nxrg),                           &
                 rs_3(nzb:nzt+1,nysg:nyng,nxlg:nxrg) )
#endif
    ENDIF
...
!                   DO  i = nxlg, nxrg
!                      DO  j = nysg, nyng
!                         IF ( nzb_s_inner(j,i) /= 0 ) rssws(j,i) = wall_sflux(0)
!                      ENDDO
!                   ENDDO
!                ENDIF
!             ENDIF
