...
! Former revisions:
! -----------------
! $Id: cpulog_mod.f90 2425 2017-09-11 14:21:39Z basit $
!
...
!> ao far.
!>
!> d3par-parameter cpu_log_barrierwait can be used to set an MPI barrier at the
!> beginning of the measurement (modus 'start' or 'continue'), to avoid that
!> idle times (due to MPI calls in the code segment, which are
...
!------------------------------------------------------------------------------!
 MODULE cpulog
    ...
    TYPE(logpoint), DIMENSION(100) ::  log_point = logpoint( 0.0_wp, 0.0_wp,   &
                                       ...
                                       0, ' ' ),                               &
                                       log_point_s = logpoint( 0.0_wp, 0.0_wp, &
                                       0.0_wp, 0.0_wp, 0.0_wp, 0.0_wp, 0.0_wp, &
                                       0, ' ' )
