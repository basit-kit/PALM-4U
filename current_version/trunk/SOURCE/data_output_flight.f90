...
! Former revisions:
! -----------------
! $Id: data_output_flight.f90 2425 2017-09-11 14:21:39Z basit $
!
...
!------------------------------------------------------------------------------!
 SUBROUTINE data_output_flight
    ...
    USE control_parameters,                                                    &
        ONLY:  message_string, num_leg, num_var_fl, run_description_header,    &
               time_since_reference_point, virtual_flight
