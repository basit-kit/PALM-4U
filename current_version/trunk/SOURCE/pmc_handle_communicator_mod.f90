...
! Former revisions:
! -----------------
! $Id: pmc_handle_communicator_mod.f90 2425 2017-09-11 14:21:39Z basit $
!
! 2013 2016-09-21 13:07:56Z suehring
...
! MPI_BCAST-calls to broadcast nesting_mode and nesting_datatransfer_mode 
! are moved out from the DO i = 1, m_ncpl loop.
! 
...
! only the total number of PEs is given in the nestpar-NAMELIST,
...
!-- Return the requested information
 ...
 SUBROUTINE read_coupling_layout( nesting_datatransfer_mode, nesting_mode,      &
    ...
    NAMELIST /nestpar/  domain_layouts, nesting_datatransfer_mode, nesting_mode
