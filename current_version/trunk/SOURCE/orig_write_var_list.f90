...
!--          list in read_var_list.
    ...
    WRITE ( 14 )  'bc_q_t_val                    '
    WRITE ( 14 )  bc_q_t_val
    WRITE ( 14 )  'bc_rs_b                       '      !bK added bc_rs_b and bc_rs_t
    WRITE ( 14 )  bc_rs_b
    WRITE ( 14 )  'bc_rs_t                       '
    WRITE ( 14 )  bc_rs_t
    WRITE ( 14 )  'bc_s_b                        '
    ...
    WRITE ( 14 )  'rs_surface                     '
    WRITE ( 14 )  rs_surface
    WRITE ( 14 )  'rs_surface_initial_change      '
    WRITE ( 14 )  rs_surface_initial_change
    WRITE ( 14 )  'rs_vertical_gradient           '
    WRITE ( 14 )  rs_vertical_gradient
    WRITE ( 14 )  'rs_vertical_gradient_level     '
    WRITE ( 14 )  rs_vertical_gradient_level
    WRITE ( 14 )  'rs_vertical_gradient_level_ind '
    WRITE ( 14 )  rs_vertical_gradient_level_ind 
    WRITE ( 14 )  's_init                        '
    WRITE ( 14 )  s_init
    WRITE ( 14 )  's_surface                     '
