...
! Former revisions:
! -----------------
! $Id: poismg_mod.f90 2425 2017-09-11 14:21:39Z basit $
!
! 2037 2016-10-26 11:15:40Z knoop
! Anelastic approximation implemented (stll error in optimized multigrid)
! 
...
! Rename subroutines and cpu-measure log points to indicate default version
! 
! 1904 2016-05-11 13:06:12Z suehring
! Bugfix: enable special_exchange_horiz only for finer grid levels.
! Some formatting adjustments and variable descriptions.
!
! 1898 2016-05-03 11:27:17Z suehring
! Bugfix: bottom and top boundary condition in resid_fast
! Bugfix: restriction at nzb+1
! formatting adjustments, variable descriptions added in some declaration blocks
!
...
! Bugfix: allow compilation without __parallel.
!
! 1575 2015-03-27 09:56:27Z raasch
! Initial revision.
! Routine re-written and optimised based on poismg.
!
...
!------------------------------------------------------------------------------!
    SUBROUTINE poismg( r )
       ...
       USE control_parameters,                                                 &
           ONLY:  gathered_size, grid_level, grid_level_count,                 &
...
!------------------------------------------------------------------------------!
    SUBROUTINE redblack( f_mg, p_mg )
       ...
       USE control_parameters,                                                 &
           ONLY:  bc_lr_cyc, bc_ns_cyc, grid_level, ibc_p_b, ibc_p_t, inflow_l,&
                  inflow_n, inflow_r, inflow_s, nest_bound_l, nest_bound_n,    &
                  nest_bound_r, nest_bound_s, ngsrb, outflow_l, outflow_n,     &
                  outflow_r, outflow_s
     ...
     SUBROUTINE special_exchange_horiz ( p_mg, color )
       ...
       USE control_parameters,                                                 &
           ONLY:  bc_lr_cyc, bc_ns_cyc, grid_level, ibc_p_b, ibc_p_t,          &
                  inflow_l, inflow_n, inflow_r, inflow_s, maximum_grid_level,  &
                  mg_switch_to_pe0_level, outflow_l, outflow_n, outflow_r,     &
                  outflow_s, synchronous_exchange
...
!--    Local variables
       ...
       LOGICAL      ::  sendrecv_in_background_save  !< dummy to reset sendrecv_in_background to prescribed value
...
#if defined ( __parallel )
       sendrecv_in_background_save = sendrecv_in_background
...
!--    Reset values to default PALM setup
       sendrecv_in_background = sendrecv_in_background_save
